...
- **It is an example blog website**
- **Fully functional website that will show the list of posts**
- **Empower readers by adding comments and liking posts**
...
2. Rails installed on your machine
2. Text editor (VSCode, Sublime, Atom, etc.)

### Setup

Clone this [repository](https://github.com/harshitajain06/Blog_App.git) to your desired folder:

```sh
  cd Blog_App
  git clone https://github.com/harshitajain06/Blog_App 
```
...
Feel free to check the [issues page](https://github.com/harshitajain06/Blog_App/issues).
