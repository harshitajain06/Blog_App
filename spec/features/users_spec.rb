...
RSpec.describe 'User', type: :feature do
    ...
    describe 'GET /show' do
        before(:example) do
            ...
            @post1 = Post.create(title: 'myTitle1', text: 'Hello1', author: @user, comments_counter: 0, likes_counter: 0)
            @post2 = Post.create(title: 'myTitle2', text: 'Hello2', author: @user, comments_counter: 0, likes_counter: 0)
            visit users_path
          end
